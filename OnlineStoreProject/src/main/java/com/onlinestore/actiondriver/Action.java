...
import com.onlinestore.actioninterface.ActionInterface;
...
public class Action extends BaseClass implements ActionInterface {
	...
	public String screenShot(WebDriver driver, String filename) {
		...
		String logPath = System.getProperty("user.dir") + "\\Logs\\log4j.log";
		File log4j = new File(logPath);
		String destination = System.getProperty("user.dir") + "\\ScreenShots\\" + filename + "_" + dateName + ".png";
		try {
			Allure.addAttachment("Screenshot", FileUtils.openInputStream(source));
			Allure.addAttachment("Log4j", FileUtils.openInputStream(log4j));
	...
	@Override
	public String getInputValue(WebElement ele) {
